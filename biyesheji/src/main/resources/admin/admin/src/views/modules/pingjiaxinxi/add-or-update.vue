	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="评价时间" prop="pingjiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.pingjiashijian" label="评价时间" prop="pingjiashijian">
					<el-input v-model="ruleForm.pingjiashijian" placeholder="评价时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="评价内容" prop="pingjianeirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.pingjianeirong" label="评价内容" prop="pingjianeirong">
                    <span :style='{"border":"1px solid rgba(126, 96, 16, .2)","padding":"0 12px","color":"inherit","background":"#fff","display":"inline-block","fontSize":"16px","lineHeight":"40px","minWidth":"200px","fontWeight":"500"}' v-html="ruleForm.pingjianeirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.pingjianeirong = this.ruleForm.pingjianeirong.replace(reg,'../../../biyesheji/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
