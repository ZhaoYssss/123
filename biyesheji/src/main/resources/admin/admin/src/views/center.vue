  ...
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='minsushangjia'"  label="民宿号" prop="minsuhao">
          <el-input v-model="ruleForm.minsuhao" readonly              placeholder="民宿号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='minsushangjia'"  label="民宿名称" prop="minsumingcheng">
          <el-input v-model="ruleForm.minsumingcheng"               placeholder="民宿名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='minsushangjia'"  label="民宿地址" prop="minsudizhi">
          <el-input v-model="ruleForm.minsudizhi"               placeholder="民宿地址" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='minsushangjia'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="flag=='minsushangjia'" label="营业执照" prop="yingyezhizhao">
          <file-upload
          tip="点击上传营业执照"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.minsuhao)&& 'minsushangjia'==this.flag){
        this.$message.error('民宿号不能为空');
        return
      }


      if((!this.ruleForm.mima)&& 'minsushangjia'==this.flag){
        this.$message.error('密码不能为空');
        return
      }


      if((!this.ruleForm.minsumingcheng)&& 'minsushangjia'==this.flag){
        this.$message.error('民宿名称不能为空');
        return
      }


      if((!this.ruleForm.minsudizhi)&& 'minsushangjia'==this.flag){
      ...
      if( 'minsushangjia' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
