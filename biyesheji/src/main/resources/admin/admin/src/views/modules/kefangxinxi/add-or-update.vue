	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="房间类型" prop="fangjianleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="房间状态" prop="fangjianzhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="房间状态" prop="fangjianzhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="房间详情" prop="fangjianxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.fangjianxiangqing" label="房间详情" prop="fangjianxiangqing">
                    <span :style='{"border":"1px solid rgba(126, 96, 16, .2)","padding":"0 12px","color":"inherit","background":"#fff","display":"inline-block","fontSize":"16px","lineHeight":"40px","minWidth":"200px","fontWeight":"500"}' v-html="ruleForm.fangjianxiangqing"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.fangjianzhuangtai = '空闲'; 			}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.minsuhao!=''&&json.minsuhao) || json.minsuhao==0) && this.$storage.get("role")!="管理员"){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fangjianxiangqing = this.ruleForm.fangjianxiangqing.replace(reg,'../../../biyesheji/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
