  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230830/f9765d454b5d41c6b3ac95880b54a215.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"1px solid #f6f6f6","padding":"50px 20px 120px 20px","boxShadow":"0 20px 20px rgba(0, 0, 0, .1)","margin":"0","borderRadius":"4px","textAlign":"center","background":"rgba(255,255,255,.5)","width":"1000px","fontSize":"16px","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"0px auto 30px","borderColor":"#ddd","color":"#191818","textAlign":"left","display":"inline-block","background":"none","borderWidth":"0px","width":"50%","lineHeight":"40px","fontSize":"30px","borderStyle":"solid","fontWeight":"600"}' class="title-container">基于Spring Boot的民宿管理系统的设计与实现登录</div>
        ...
        <div :style='{"margin":"40px auto 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"50%",
        "fontSize":"16px","position":"relative","justifyContent":"center"}'>
          <el-button v-if="loginType==1" :style='{"border":"0","cursor":"pointer",
          "padding":"0 0 0 50px","margin":"0","color":"#fff","textAlign":"center","letterSpacing":"50px","outline":"none",
          "borderRadius":"0px","top":"50px","background":"linear-gradient(180deg, rgba(160,8,8,1) 0%, rgba(222,40,40,1) 50%, " +
           "rgba(160,8,8,1) 100%)","width":"240px","fontSize":"24px","position":"absolute","height":"66px"}'
                     type="primary" @click="login()" class="loginInBt">登录</el-button>

          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 8px","margin":"0 5px 5px","borderColor":"rgba(167,142,68,1)","color":"rgba(167,142,68,1)","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0px","width":"auto","fontSize":"inherit","borderStyle":"solid","fontWeight":"500","height":"auto"}' type="primary" @click="register('minsushangjia')" class="register">注册民宿商家</el-button>
        </div>
      </el-form>
