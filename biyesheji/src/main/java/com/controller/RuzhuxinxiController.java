...
public class RuzhuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,RuzhuxinxiEntity ruzhuxinxi,
		...
		if(tableName.equals("minsushangjia")) {
			ruzhuxinxi.setMinsuhao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<RuzhuxinxiEntity> list = new ArrayList<RuzhuxinxiEntity>();
        for(Long id : ids) {
            RuzhuxinxiEntity ruzhuxinxi = ruzhuxinxiService.selectById(id);
            ruzhuxinxi.setSfsh(sfsh);
            ruzhuxinxi.setShhf(shhf);
            list.add(ruzhuxinxi);
        }
        ruzhuxinxiService.updateBatchById(list);
        return R.ok();
    }
